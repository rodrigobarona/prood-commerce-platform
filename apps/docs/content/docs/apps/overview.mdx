...
description: The seven runtime applications in the Prood monorepo and how they interact.
---
...
| Admin | Restricted admin URL (e.g. `admin.example.com`) | Platform operations only |
