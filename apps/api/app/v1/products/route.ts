...
import { searchProductsQuery } from "@/lib/schemas"
...
export async function GET(req: Request) {
  try {
    ...
    const query = readQuery(req, searchProductsQuery)
    return NextResponse.json(await catalog.searchProducts(orgId, query))
  } catch (err) {
